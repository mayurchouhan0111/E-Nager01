...
export const CHECKLIST_DATA = {
  ...
  waterConnection: {
    ...
    items: [
      {
        id: 'wc_1',
        title: '1. आईडी प्रूफ एवं संपत्ति/शपथ पत्र (अनिवार्य)',
        detail: 'आधार कार्ड / SSSM ID समग्र आईडी / बिजली का बिल / संपत्ति कर की नवीनतम रसीद / नोटरी शपथ नॉन जुडिशल पत्र ₹1000',
        required: true
      },
      {
        id: 'wc_2',
        title: '2. साइट प्लान नक्शा (अनिवार्य)',
        detail: 'नल कनेक्शन जिस स्थान से ले जाना है उसका साइट प्लान (Site Plan)',
        required: true
      },
      {
        id: 'wc_3',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredKeys.map(key => {
          ...
          return (
            <div
              key={group.id}
              className={`border rounded-2xl p-5 transition-all duration-300 ${isAllChecked ? 'bg-emerald-50/40 border-emerald-300 shadow-xs' : 'bg-slate-50/60 border-slate-200 hover:border-slate-300'
                }`}
            >
              <div className="flex items-start justify-between gap-2 mb-3 pb-3 border-b border-slate-200/80">
                ...
                <div className="text-right shrink-0">
                  <span className={`text-[11px] font-mono font-bold px-2 py-1 rounded-lg ${isAllChecked ? 'bg-emerald-600 text-white' : 'bg-slate-200 text-slate-700'
                    }`}>
                ...
                {group.items.map(item => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-3 rounded-xl border transition-all cursor-pointer select-none flex items-start gap-3 ${isChecked
