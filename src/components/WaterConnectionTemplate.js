...
export default function WaterConnectionTemplate({ record }) {
  ...
  return (
    <div className="print-page-a4 bg-white text-slate-900 p-6 max-w-4xl mx-auto border-8 border-double border-teal-900/40 shadow-2xl relative font-serif print:p-3 print:border-4 print:max-h-[280mm] print:overflow-hidden print:break-inside-avoid">
