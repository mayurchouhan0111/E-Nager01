...
function getLocalNoDuesCertificates() {
  ...
  try {
    ...
    const data = localStorage.getItem(key) || localStorage.getItem('nd_no_dues_certificates');
...
export async function getNoDuesCertificates(param1 = null, param2 = false) {
  ...
  try {
    ...
    console.warn('[NoDuesService] Firestore read notice:', error.message);
    return localItems;
  }
}
